...
/**
 * No additional memory usage. Space optimized implementation. <br>
...
public class DistinctCharactersSubsequence {
	...
	public static void main(String[] args) {
		...
		// '0'. We will initialize all the values in the array as -1, so that we
		// can track which all characters have come.
		// Hence all the a indices where value is 0 or more, have appeared in
		// the string.
		// This will find the number of distinct characters in the string.
