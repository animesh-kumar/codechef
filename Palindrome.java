...
public class Palindrome {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < t; i++) {
			...
			// We assume that a Palindrome will alway match the 
			// required characterstic because, deleting 
			// one character from 'middle' will always let it remain a palindrome.
			...
			if (k == -1) {
				...
				// There are two possiblities here : Either the mismatch 
